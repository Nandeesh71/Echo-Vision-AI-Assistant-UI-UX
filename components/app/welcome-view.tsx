    ...
    >
      <div className="flex w-full max-w-2xl flex-col items-center justify-center text-center">
        ...
        <div className="relative mb-8 flex flex-col items-center justify-center">
          ...
          <p className="max-w-md text-lg leading-relaxed font-medium text-slate-400">
        ...
        <div className="flex w-full flex-col items-center gap-4">
          ...
          <Button
            ...
            size="lg"
            asChild
            className="border-primary text-primary hover:bg-primary/5 h-12 w-full max-w-[240px] rounded-full bg-transparent text-sm font-medium transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        {/* 4. Trust Indicators */}
        <p className="mt-8 text-[10px] font-medium tracking-[0.15em] text-slate-500 uppercase opacity-60">
