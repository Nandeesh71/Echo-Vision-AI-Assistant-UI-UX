...
export const agentTrackToggleVariants = cva(['size-9'], {
  variants: {
    variant: {
      ...
      ghost: [
        'bg-transparent border-none shadow-none text-white/70 hover:text-white',
        'data-[state=on]:text-primary data-[state=on]:bg-white/10',
        'data-[state=off]:text-destructive/80 data-[state=off]:bg-destructive/5',
      ],
    },
  },
  defaultVariants: {
